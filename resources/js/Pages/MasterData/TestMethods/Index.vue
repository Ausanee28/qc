...
const props = defineProps({ testMethods: Array, equipments: Array });
        ...
        <div class="w-full">
            ...
            <div class="bg-white border border-gray-200 shadow-sm rounded-xl overflow-hidden">
                ...
                <div class="px-6 py-3 bg-gray-50 border-t border-gray-200 text-xs text-gray-500">
                    {{ filtered.length }} of {{ testMethods.length }} methods
                </div>
            </div>
        </div>
            ...
            <div class="relative bg-white rounded-xl shadow-xl w-full max-w-md z-10 p-6">
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="mb-6">
                        ...
                        <select v-model="form.equipment_id" required class="w-full h-10 px-3 rounded-lg border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900">
