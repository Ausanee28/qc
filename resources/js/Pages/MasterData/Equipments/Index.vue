            ...
            <div class="relative bg-white rounded-xl shadow-xl w-full max-w-md z-10 p-6">
                ...
                <form @submit.prevent="submit">
                    <div class="mb-6">
                        ...
                        <input type="text" v-model="form.equipment_name" required class="w-full h-10 px-3 rounded-lg border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900" />
