...
<template>
    <GuestLayout>
        ...
        <div class="ent-header">
            <h1 class="ent-title">Set new password</h1>
            <p class="ent-subtitle">Your new password must be different from previously used passwords.</p>
        </div>
        ...
        <form @submit.prevent="submit" class="ent-form">
            <div class="ent-field-group">
                ...
                <div class="ent-input-wrapper">
                    <input id="email" type="email" v-model="form.email" required class="ent-input" :class="{ 'has-error': form.errors.email }" readonly style="background-color:rgba(255,255,255,0.06);color:#a8a29e" />
                </div>
                <InputError class="ent-error" :message="form.errors.email" />
            </div>

            <div class="ent-field-group">
                <label for="password" class="ent-label">New Password</label>
                <div class="ent-input-wrapper">
                    <input id="password" :type="showPassword ? 'text' : 'password'" v-model="form.password" required autofocus placeholder="••••••••" class="ent-input ent-input-pw" :class="{ 'has-error': form.errors.password }" />
            ...
            <div class="ent-field-group">
                <label for="password_confirmation" class="ent-label">Confirm New Password</label>
                <div class="ent-input-wrapper">
