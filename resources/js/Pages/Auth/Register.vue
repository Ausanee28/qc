    ...
    <GuestLayout>
        ...
        <form @submit.prevent="submit" class="ent-form">
            ...
            <div class="ent-grid">
                <div class="ent-field-group">
                    ...
                    <div class="ent-input-wrapper">
                        <input id="user_name" v-model="form.user_name" type="text" required autofocus placeholder="e.g. inspector1" class="ent-input" :class="{ 'has-error': form.errors.user_name }" />
                    </div>
                ...
                <div class="ent-field-group">
                    ...
                    <div class="ent-input-wrapper">
                        <input id="employee_id" v-model="form.employee_id" type="text" required placeholder="e.g. EMP004" class="ent-input" :class="{ 'has-error': form.errors.employee_id }" />
                    </div>
            ...
            <div class="ent-field-group">
                ...
                <div class="ent-input-wrapper">
                    <input id="name" v-model="form.name" type="text" required placeholder="e.g. Somchai Tester" class="ent-input" :class="{ 'has-error': form.errors.name }" />
                </div>
            ...
            <div class="ent-grid">
                <div class="ent-field-group">
                    ...
                    <div class="ent-input-wrapper">
                        <input id="password" v-model="form.password" :type="showPassword ? 'text' : 'password'" required placeholder="Create a secure password" class="ent-input ent-input-pw" :class="{ 'has-error': form.errors.password }" />
                ...
                <div class="ent-field-group">
                    ...
                    <div class="ent-input-wrapper">
                        <input id="password_confirmation" v-model="form.password_confirmation" :type="showPassword ? 'text' : 'password'" required placeholder="Re-enter your password" class="ent-input" :class="{ 'has-error': form.errors.password_confirmation }" />
                    </div>
