...
<template>
    <GuestLayout>
        ...
        <div class="ent-header">
            <span class="ent-kicker">Internal Access</span>
            <h1 class="ent-title">Create your inspector account</h1>
            <p class="ent-subtitle">Register with your employee ID to access the QC Lab workflow and daily inspection tools.</p>
        </div>

        <form @submit.prevent="submit" class="ent-form">
            <div class="ent-info-card">
                <p class="ent-info-label">What you need</p>
                <p class="ent-info-text">Use the employee ID assigned by your team. New accounts are created as inspector access for internal staff.</p>
            </div>
            ...
            <div class="ent-grid">
                <div class="ent-field-group">
                    ...
                    <div class="ent-input-wrapper">
                        <input id="user_name" v-model="form.user_name" type="text" required autofocus class="ent-input" :class="{ 'has-error': form.errors.user_name }" />
                    </div>
                ...
                <div class="ent-field-group">
                    ...
                    <div class="ent-input-wrapper">
                        <input id="employee_id" v-model="form.employee_id" type="text" required class="ent-input" :class="{ 'has-error': form.errors.employee_id }" />
                    </div>
            ...
            <div class="ent-field-group">
                ...
                <div class="ent-input-wrapper">
                    <input id="name" v-model="form.name" type="text" required class="ent-input" :class="{ 'has-error': form.errors.name }" />
                </div>
            ...
            <div class="ent-grid">
                <div class="ent-field-group">
                    ...
                    <div class="ent-input-wrapper">
                        <input id="password" v-model="form.password" :type="showPassword ? 'text' : 'password'" required class="ent-input ent-input-pw" :class="{ 'has-error': form.errors.password }" />
                ...
                <div class="ent-field-group">
                    ...
                    <div class="ent-input-wrapper">
                        <input id="password_confirmation" v-model="form.password_confirmation" :type="showPassword ? 'text' : 'password'" required class="ent-input" :class="{ 'has-error': form.errors.password_confirmation }" />
                    </div>
...
.ent-info-card {
    padding: 14px 16px;
    border-radius: 16px;
    background: linear-gradient(180deg, rgba(251, 146, 60, 0.12), rgba(120, 53, 15, 0.2));
...
:global(.theme-guest[data-theme='light'] .ent-kicker) {
    color: #1d4ed8;
...
:global(.theme-guest[data-theme='light'] .ent-title) {
    color: #0f172a;
}
...
:global(.theme-guest[data-theme='light'] .ent-subtitle),
:global(.theme-guest[data-theme='light'] .ent-footer-link),
:global(.theme-guest[data-theme='light'] .ent-label) {
    color: #475569;
}

:global(html[data-theme='light'] .ent-info-card),
:global(.theme-guest[data-theme='light'] .ent-info-card) {
...
:global(.theme-guest[data-theme='light'] .ent-info-label) {
    color: #1d4ed8;
}

:global(html[data-theme='light'] .ent-info-text),
:global(.theme-guest[data-theme='light'] .ent-info-text) {
    color: #334155;
}

:global(html[data-theme='light'] .ent-input),
:global(.theme-guest[data-theme='light'] .ent-input) {
    color: #0f172a;
...
:global(.theme-guest[data-theme='light'] .ent-input::placeholder) {
    color: #94a3b8;
}

:global(html[data-theme='light'] .ent-input:hover),
:global(.theme-guest[data-theme='light'] .ent-input:hover) {
    border-color: rgba(29, 78, 216, 0.16);
}

:global(html[data-theme='light'] .ent-input:focus),
:global(.theme-guest[data-theme='light'] .ent-input:focus) {
...
:global(.theme-guest[data-theme='light'] .ent-eye-btn:hover) {
    color: #1d4ed8;
    background-color: rgba(219, 234, 254, 0.92);
}

:global(html[data-theme='light'] .ent-submit-btn),
:global(.theme-guest[data-theme='light'] .ent-submit-btn) {
...
:global(.theme-guest[data-theme='light'] .ent-submit-btn:disabled) {
    background: rgba(226, 232, 240, 0.9);
    color: #94a3b8;
}

:global(html[data-theme='light'] .ent-link),
:global(.theme-guest[data-theme='light'] .ent-link) {
    color: #1e40af;
}
