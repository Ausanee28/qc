...
class PerformanceController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Performance/Index', [
            'inspectors' => fn () => Cache::remember('performance.inspectors.30d', now()->addMinutes(3), function () use ($hasDetailDeletedAt, $windowStart) {
            ...
            'details' => fn () => Cache::remember('performance.details.30d.recent50', now()->addMinutes(3), function () use ($hasDetailDeletedAt, $hasHeaderDeletedAt, $windowStart) {
