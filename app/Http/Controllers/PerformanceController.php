...
class PerformanceController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Performance/Index', [
            'inspectors' => Inertia::defer(function () use ($hasDetailDeletedAt, $windowStart) {
                return Cache::remember('performance.inspectors.30d', now()->addMinutes(3), function () use ($hasDetailDeletedAt, $windowStart) {
            ...
            'details' => Inertia::defer(function () use ($hasDetailDeletedAt, $hasHeaderDeletedAt, $windowStart) {
                return Cache::remember('performance.details.30d.recent50', now()->addMinutes(3), function () use ($hasDetailDeletedAt, $hasHeaderDeletedAt, $windowStart) {
